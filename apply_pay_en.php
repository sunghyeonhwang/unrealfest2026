...
if (ufs_reg_closed_offline()) ufs_reg_closed_page();   // 마감 또는 현장 정원 도달(영문=현장)
...
$gopaymethod  = "Card";
$acceptmethod = "LANG(ENGLISH):FORCARD:below1000:centerCd(Y)";   // LANG(ENGLISH)=영문창 + FORCARD=해외카드 전용(영문창은 FORCARD 필요)
