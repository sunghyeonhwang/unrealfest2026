...
$ORDERS = array(
  ...
  // 2026-08-26 한국콘텐츠진흥원 부족분 — 강성근(apply#5019) 60,000원이 8/14 부분취소로
  // 환불됐는데 등록은 유효 상태로 남아 실제 참석 인원(59명)보다 결제 잔액이 1인분 적다.
  // 원거래(StdpayCARD...124186)는 부분취소 이력이 있어 증액이 불가하므로 별도 건으로 받는다.
  'kocca1' => array(
    'item'  => '언리얼 페스트 서울 2026 참가비 부족분 1인 (한국콘텐츠진흥원)',
    'amount'=> 60000,
    'name'  => '박소임',
    'tel'   => '01032327591',
    'email' => 'sizr0225@kocca.kr',
    'token' => 'kocca26-1pax-6176267bd9',
  ),
  'kia3' => array(
