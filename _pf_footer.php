<?php /* Unreal Fest Seoul 2026 — PHP 페이지용 푸터 (src/app/components/Footer.tsx 1:1) */ ?>
  ...
  <div class="max-w-7xl mx-auto px-6">
    <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
      <div class="col-span-1 md:col-span-2">
        ...
        <div class="flex gap-4">
          ...
          <a href="https://cafe.naver.com/unrealenginekr" target="_blank" rel="noopener noreferrer" aria-label="네이버 카페" class="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-slate-400 hover:text-white hover:border-[#00C1D5] transition-colors">
          ...
          <a href="https://pf.kakao.com/_xfdmNb" target="_blank" rel="noopener noreferrer" aria-label="카카오톡 채널" class="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-slate-400 hover:text-white hover:border-[#00C1D5] transition-colors">
      ...
      <div>
        ...
        <ul class="space-y-4 text-slate-400">
          <li><a href="https://epiclounge.co.kr" class="hover:text-white transition-colors flex items-center gap-1">새소식 <svg class="w-3 h-3 opacity-50" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M7 7h10v10"/><path d="M7 17 17 7"/></svg></a></li>
          <li><a href="https://epiclounge.co.kr" class="hover:text-white transition-colors flex items-center gap-1">이벤트 <svg class="w-3 h-3 opacity-50" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M7 7h10v10"/><path d="M7 17 17 7"/></svg></a></li>
          <li><a href="https://epiclounge.co.kr" class="hover:text-white transition-colors flex items-center gap-1">리소스 <svg class="w-3 h-3 opacity-50" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M7 7h10v10"/><path d="M7 17 17 7"/></svg></a></li>
        </ul>
      </div>
    </div>
    <div class="pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4 text-slate-500">
      ...
      <div class="flex gap-6">
        <a href="https://epiclounge.co.kr/v3/contents/v4/ode.php" target="_blank" rel="noopener noreferrer" class="hover:text-white transition-colors">이용약관</a>
        <a href="https://epiclounge.co.kr/v3/contents/v4/personal.php" target="_blank" rel="noopener noreferrer" class="hover:text-white transition-colors">개인정보처리방침</a>
        <a href="https://epiclounge.co.kr/v3/contents/v4/cookie.php" target="_blank" rel="noopener noreferrer" class="hover:text-white transition-colors">쿠키 정책</a>
      </div>
    </div>
  </div>
</footer>
