...
<?php if (!$session): ?>
  <div class="bg-[#09090b] min-h-screen text-white pt-32 text-center">
    ...
    <a href="schedule_s.php" class="text-[#00C1D5] mt-4 inline-block hover:underline">아젠다로 돌아가기</a>
  </div>
<?php else:
...
<div class="bg-[#09090b] min-h-screen text-white">
  ...
  <section class="bg-[#0e0f14] border-b border-[#27272a] pt-24 pb-10">
    <div class="max-w-7xl mx-auto px-6">
      <a href="schedule_s.php" class="inline-flex items-center gap-2 text-sm text-[#71717a] hover:text-white transition-colors mb-6">
    ...
    <div class="grid lg:grid-cols-[1fr_360px] gap-12">
      ...
      <div class="space-y-6">
        ...
        <div class="p-6 text-center">
          ...
          <a href="index_s.php#register" class="inline-flex items-center justify-center w-full py-3 bg-[#00C1D5] hover:bg-[#00a8ba] text-[#09090b] font-bold transition-colors clip-btn-sm">지금 등록하기</a>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="max-w-7xl mx-auto px-6 pb-24">
    ...
    <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
      <?php foreach ($related as $r): ?>
        <a href="session_s.php?id=<?= e($r['id']) ?>" class="bg-[#0e0f14] p-5 hover:bg-[#111115] transition-colors flex flex-col gap-2">
