...
$overview = [
  ...
  'paragraphs' => [
    ...
    '리얼타임 렌더링, 애니메이션, 버추얼 프로덕션, 메타휴먼, 디지털 트윈, AI 기반 제작 워크플로 등 다양한 리얼타임 기술과 현업 전문가들의 실전 인사이트를 통해 인터랙티브 3D 경험 제작의 새로운 가능성을 발견해 보세요.',
  ],
  'features' => [
    ...
    ['icon'=>'video', 'title'=>'일부 세션 온라인 생중계', 'desc'=>'현장에 오지 못해도 온라인 생중계로 언리얼 페스트 서울 2026을 만나보세요.'],
  ],
];
