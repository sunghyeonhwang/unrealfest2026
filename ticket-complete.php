...
<main class="pt-32 pb-24 min-h-screen">
  <div class="max-w-2xl mx-auto px-6 text-center">
    <?php if (!$row): ?>
      ...
      <a href="index.html" class="clip-btn inline-block bg-[#00C1D5] hover:bg-[#00a8ba] text-[#09090b] px-6 py-3 font-bold">홈으로</a>
    <?php elseif ($is_online): ?>
      ...
      <div class="flex flex-col sm:flex-row gap-3 justify-center">
        ...
        <a href="index.html" class="clip-btn bg-white/10 hover:bg-white/20 text-white px-8 py-4 font-bold">홈으로</a>
      </div>
    <?php elseif ($is_vbank): ?>
      <div class="w-16 h-16 rounded-full bg-[rgba(0,193,213,0.15)] flex items-center justify-center mx-auto mb-6">
      ...
      <p class="text-[#a1a1aa] mb-8">아래 계좌로 입금하시면 등록이 최종 확정됩니다.</p>
      ...
      <a href="index.html" class="clip-btn inline-block bg-[#00C1D5] hover:bg-[#00a8ba] text-[#09090b] px-8 py-4 font-bold">홈으로</a>
    <?php else: ?>
      <div class="w-16 h-16 rounded-full bg-[rgba(0,193,213,0.15)] flex items-center justify-center mx-auto mb-6">
        <svg class="w-9 h-9 text-[#00C1D5]" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21.801 10A10 10 0 1 1 17 3.335"/><path d="m9 11 3 3L22 4"/></svg>
      </div>
      <h1 class="text-3xl md:text-4xl font-bold mb-3">등록이 완료되었습니다!</h1>
      <p class="text-[#a1a1aa] mb-10">행사 당일 아래 QR 코드로 현장 체크인하세요.</p>

      <?php if ($qr_jpg): ?>
      <div class="bg-white p-5 inline-block mb-8 clip-tr-16">
        <img src="<?= asset_v($qr_jpg) ?>" alt="체크인 QR" class="w-44 h-44">
      </div>
      <?php endif; ?>
